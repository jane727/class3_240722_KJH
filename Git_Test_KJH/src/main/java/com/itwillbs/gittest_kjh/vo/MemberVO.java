package com.itwillbs.gittest_kjh.vo;
...
public class MemberVO {
	...
	// 또한, DB 에서의 컬럼명은 email 이므로 조회 데이터 저장을 위해서는 
	// email 멤버변수도 필요함
	// --------
	// 만약, 뷰페이지(JSP)에서 자바스크립트를 활용하여 
	// email1, email2 를 email 파라미터로 결합하여 폼 파라미터로 전송할 경우 
	...
	private Date withdraw; // 탈퇴일자 - java.sql.Date
