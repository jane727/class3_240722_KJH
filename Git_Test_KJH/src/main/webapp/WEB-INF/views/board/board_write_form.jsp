...
<body>
	...
	<article id="writeForm">
		<h1>게시판 글 등록</h1>
		<%-- 기본적으로 폼태그는 enctype 값이 "application/x-www-form-urlencoded" 값으로 설정됨(기본값) --%>
...
<!-- 				</tr> -->
				...
				<tr>
					...
					<td class="write_td_right">
						<%-- 첨부파일 기능은 input 태그의 type="file" 속성을 활용 --%>
						<%-- 주의! 업로드 시 실제 파일을 서버로 전송하려면 form 태그의 enctype 속성 필수! --%>
